...
export default async function handler(req, res) {
  ...
  try {
    ...
    const browserOptions = {
      ...
      // For production environments, you might need to specify executablePath
      // executablePath: process.env.PUPPETEER_EXECUTABLE_PATH || '/usr/bin/chromium-browser',
    };

    // For Vercel specifically, you might need this:
    if (process.env.VERCEL) {
      browserOptions.executablePath = await require('puppeteer').executablePath();
    }
